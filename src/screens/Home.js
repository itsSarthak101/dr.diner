...
export default function Home() {
  return (
    <div>
      ...
      <h1 className="wow fadeInUp" data-wow-delay=".2s"><span style={{color: 'red', fontWeight: 'bold'}}>DOCTOR DINER </span><span>For all your Hunger Problems</span> </h1>
      ...
      <img src="assets/img/hero/food_photo_3.png" style={{ width: '100%', height: '100%', padding: '0px' }} alt="" />
      </div>
      </div>
      </div>
      </div>
